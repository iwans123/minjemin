        ...
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand">
                    <span class="align-middle">M-Jemin</span>
                </a>
                <ul class="sidebar-nav">
                    ...
                    @hasrole('admin')
                        <li class="sidebar-item {{ Route::is('employee.*') ? 'active' : '' }}">
                        ...
                        <li class="sidebar-item {{ Route::is('vehicle.*') ? 'active' : '' }}">
                            <a class="sidebar-link" href="{{ route('vehicle.index') }}">
                    ...
                    @if (Auth::user()->position == 'low' && Auth::user()->hasRole('user'))
                        <li class="sidebar-item {{ Route::is('verification.*') ? 'active' : '' }}">
                            <a class="sidebar-link" href="{{ route('verification.low') }}">
                                <i class="align-middle" data-feather="server"></i> <span
                                    class="align-middle">Verifikasi</span>
                            </a>
                        </li>
                    @endif

                    @if (Auth::user()->position == 'high' && Auth::user()->hasRole('user'))
                        <li class="sidebar-item {{ Route::is('verification.*') ? 'active' : '' }}">
                            <a class="sidebar-link" href="{{ route('verification.high') }}">
                                <i class="align-middle" data-feather="server"></i> <span
                                    class="align-middle">Verifikasi</span>
                            </a>
                        </li>
