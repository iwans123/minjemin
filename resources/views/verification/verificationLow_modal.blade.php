...
<button type="button" class="btn btn-warning" data-bs-toggle="modal"
    data-bs-target="#verificationLow{{ $transaction->id }}">
    Verifikasi
</button>

<!-- Modal -->
<div class="modal fade" id="verificationLow{{ $transaction->id }}" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('verification.updateLow', $transaction->id) }}" method="POST">
                    @method('PUT')
                    @csrf
                    <div class="mb-3">
